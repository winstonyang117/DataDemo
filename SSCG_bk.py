...
def single_cardiac_cycle(duration=10, length=None, sampling_rate=100, heart_rate=60, respiratory_rate=15, systolic=115, diastolic=70):
    ...
    cardiac = scipy.signal.resample(cardiac, desired_single_cardiac_length) 
    ...
    for i in tqdm(range(1, heartbeats+1)):
...
noise_signal = single_cardiac_cycle(heart_rate=120)
